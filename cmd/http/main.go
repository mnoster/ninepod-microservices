...
func main() {
	...
	var (
		podsSvc podssvc.Service
	)
	{
		podsSvc = pods.NewPods(logger)
	}

	// Wrap the services in endpoints that can be invoked from other services
	// potentially running in different processes.
	var (
		podsEndpoints *podssvc.Endpoints
	)
	{
		podsEndpoints = podssvc.NewEndpoints(podsSvc)
	}
	...
	case "svc":
		{
			...
			handleHTTPServer(ctx, u, podsEndpoints, &wg, errc, logger, *dbgF)
		}
